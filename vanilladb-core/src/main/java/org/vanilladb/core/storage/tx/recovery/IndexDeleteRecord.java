...
public class IndexDeleteRecord implements LogRecord {
	private long txNum;
	...
	/**
	 * Creates a new index deletion log record.
	 * 
	 * @param txNum
	 ...
	 */
	public IndexDeleteRecord(long txNum, String dataTblName,
	 ...
	 */
	public IndexDeleteRecord(BasicLogRecord rec) {
	...
	public long writeToLog() {
		Constant[] rec = new Constant[] { new IntegerConstant(OP_INDEX_DELETE),
	...
	public String toString() {
		return "<INDEX_DELETE " + txNum + " " + dataTblName + " "
